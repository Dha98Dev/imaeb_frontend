...
const routes: Routes = [
  {
    ...
    children: [
      {
        path: 'principal_alumno/:cct/:grupo/:idAlumno/:examenId',
        component: PrincipalPadreFamilia,
      },
      {
        path: 'resultados_area/:area/:idAlumno/:alumnoExamenId',
        component: ResultadosMateria,
